...
// both platforms, or null when the bridge does not know. The MobBridge.kt
// generated by mob_new 0.4.33+ implements uiViewTree() (MOB-157) and sends
// null for class, bg_color and text_color; older apps have no method, and
// view_tree returns {:error, :not_loaded}.
...
const nif_funcs = [_]erts.ErlNifFunc{
    ...
    .{ .name = "screen_info", .arity = 0, .fptr = nif_screen_info, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    .{ .name = "tap", .arity = 1, .fptr = nif_tap, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    .{ .name = "tap_xy", .arity = 2, .fptr = nif_tap_xy, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    .{ .name = "type_text", .arity = 1, .fptr = nif_type_text, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    .{ .name = "delete_backward", .arity = 0, .fptr = nif_delete_backward, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    // Not dirty: this one is a stub that returns :not_implemented without
    // touching the UI thread. Flag it when it grows a real body.
    ...
    .{ .name = "scroll_to", .arity = 3, .fptr = nif_scroll_to, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
    ...
    .{ .name = "webview_can_go_back", .arity = 0, .fptr = nif_webview_can_go_back, .flags = erts.ERL_NIF_DIRTY_JOB_IO_BOUND },
